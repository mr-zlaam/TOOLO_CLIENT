...
export const BackgroundBeamsWithCollision = ({ children, className }: { children: React.ReactNode; className?: string }) => {
  ...
  return (
    <div
      ref={parentRef}
      className={cn(
        "h-96 md:h-[40rem] bg-gradient-to-b from-blue-50 to-white dark:from-neutral-950 dark:to-neutral-800 relative flex items-center w-full justify-center overflow-hidden",
