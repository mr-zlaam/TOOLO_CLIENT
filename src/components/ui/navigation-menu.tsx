...
const navigationMenuTriggerStyle = cva(
  ...
  "group inline-flex h-9 w-max items-center justify-center rounded-md bg-transparent px-4 py-2 text-sm font-medium transition-colors hover:bg-blue-50/60 hover:text-primary focus:bg-blue-50/80 focus:text-primary disabled:pointer-events-none disabled:opacity-50 data-[state=open]:bg-blue-50/70 data-[state=open]:text-primary data-[state=open]:hover:bg-blue-50/80 ring-ring/10 dark:ring-ring/20 dark:outline-ring/40 outline-ring/50 transition-[color,box-shadow] focus-visible:ring-4 focus-visible:outline-1"
);
